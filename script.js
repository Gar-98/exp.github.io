...
function endGame() {
  endGameDialog.classList.add("end_game__open"); //включаем диалоговое окно с результатами и кнопкой перезапуска
  score.innerHTML = bird.point; //устанавливаем заработанное количество очков
}

btn_restart.addEventListener("click", function () {
  endGameDialog.classList.remove("end_game__open"); //удалили класс, чтобы спрятать окно
